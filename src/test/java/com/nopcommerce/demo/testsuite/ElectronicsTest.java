...
2.42 Verify the text “Welcome to our store”
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        electronicsPage.sendText(electronicsPage.firstName, "Manini");
        electronicsPage.sendText(electronicsPage.lastName, "Sheth");
        ...
        electronicsPage.sendText(electronicsPage.password, "Manini123");
        electronicsPage.sendText(electronicsPage.confirmPassword, "Manini123");
        ...
        electronicsPage.sendText(electronicsPage.cardHolderName, "Manini sheth");
